...
const GROUPS = [
  ...
  },
  {
    ...
    vars: [
      ...
      { key: "SHOP_STORE_URL", need: "optional", why: "The merchandise store, e.g. https://shop.example.com. Overrides shop.storeUrl in site.json. Unset in both leaves /shop dormant rather than pointed at somebody else's storefront. No token is needed: Shopify publishes the catalogue openly." },
